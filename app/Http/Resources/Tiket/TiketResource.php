...
class TiketResource
{
    public function respondDataMaping($resource)
    {
        return [
            ...
            'usage_time' => ($resource['start_time_usage'] != null && $resource['end_time_usage'] != null) ? \Carbon\Carbon::parse($resource['start_time_usage'])->format('H:i') . ' - ' . \Carbon\Carbon::parse($resource['end_time_usage'])->format('H:i') : null,
    ...
    public function respondDataMapingOrder($resource)
    {
        return [
            ...
            'badge' => $resource['master_tiket']['badge'],
