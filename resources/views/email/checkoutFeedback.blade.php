                        ...
                        <tbody>
                            <tr>
                                <td align="left" style="padding-left:30px;">
                                    ...
                                    <h2 style="color: #00A2B9;margin: 0; padding: 0;
                                    line-height: 1.6;">
                                        {{ $order->payment->payment_method }} sebelum
                                        @php
                                            \Carbon\Carbon::setLocale('id');
                                        @endphp
                                        {{ \Carbon\Carbon::parse($order->order_date)->isoFormat('dddd, D MMMM Y, H:m')}} WIB
                                    </h2>
            ...
            <tr>
                <td width="600">
                    <div style="padding-left: 30px; padding-right: 30px;">
                        <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~1640143506d37b60b7-80b4-4a35-9e8e-e3491a335612.png" alt=""
                        style="max-width: 150px;display:block;margin-left: auto;margin-right: auto;">
                        <p style="color: #666;font-size: 15px;">Terima kasih telah memilih Marketplace sebagai tempat belanja pilihan Anda. Segera lakukan pembayaran pesanan Anda dengan detail sebagai berikut:</p>
                        ...
                        margin-left:30px;">
                            <div style=" padding: 2px 5px;">
                                <table style="margin: 0px 10px 0px 10px;">
                                    <tr>
                                        <td style="font-size: 14px;color:#666;padding: 10px 30px 10px 10px;">Metode Pembayaran</td>
                                        <td style="font-weight: bold;">{{ $order->payment->payment_method ?? '-' }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 14px;color:#666;padding: 10px 30px 10px 10px;">Nomor Virtual Account</td>
                                        <td style="font-weight: bold;"> - </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 14px;color:#666;padding: 10px 30px 10px 10px;">Total Pembayaran</td>
                        ...
                        <div>
                            ...
                            <table style="width: 100%;">
                                <tbody>
                                    <tr>
                                        <td style="padding:0px 0px 30px 0px;font-size: 14px;font-weight: bold;width: 50%;">Subtotal Tagihan</td>
                                        <td style="padding:0px 0px 30px 0px;font-weight:bold;text-align:right;">Rp. {{ number_format($order->detail->sum('total_price') + $order->delivery->delivery_fee + $order->detail->sum('total_insurance_cost'))}}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 14px;color:#666;width: 50%;">Diskon</td>
                                        <td style="font-weight:bold;text-align:right;">Rp {{ number_format($order->detail->sum('total_discount')) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <hr>
                            <table style="width: 100%;">
                                <tbody>
                                    <tr>
                                        <td style="padding:0px 0px 30px 0px;font-size: 14px;font-weight: bold;width: 50%;">Total Tagihan</td>
                                        <td style="padding:0px 0px 30px 0px;font-weight:bold;text-align:right;color: #FF5E5E">Rp {{number_format($order->payment->payment_amount, 2, ',', '.')}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width: 40%">
                                                ...
                                                <p style="font-weight: bold;margin:0px 0px 5px 0px;">{{$item->quantity}} x Rp {{number_format($item->price, 2, ',', '.')}}</p>
                                            </td>
                                            <td style="width: 15%">
