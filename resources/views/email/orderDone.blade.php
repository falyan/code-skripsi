                            ...
                            <tr>
                                <td align="left" style="padding-left:30px;">
                                    ...
                                    line-height: 1.6;">
                                        ...
                                        <br>
                                        Terima kasih sudah berbelanja di Marketplace
                                    </h2>
                                    @php
            ...
            <tr>
                <td width="600">
                    <div style="padding-left: 30px; padding-right: 30px;">
                        ...
                        <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~16402402689856441f-1dd5-422d-ad2d-a7b32a9bac8b.png" alt=""
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width: 15%">
                                                <p style="font-weight: bold;color: #FF5E5E">Rp {{ number_format($item->total_price,  2, ',', '.') }}</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div style="margin-top: 30px;">
                            ...
                            <table style="width: 100%;">
                                <tbody>
                                    <tr>
                                        <td style="padding:0px 0px 30px 0px;font-size: 14px;font-weight: bold;width: 50%;">Total Pembayaran</td>
                                ...
                                <table style="width: 100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50%;">
                                                <p style="color: #666;margin-top: 0;font-weight: bold;">{{ $order->delivery->receiver_name }}</p>
