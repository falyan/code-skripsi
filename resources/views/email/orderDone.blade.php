            ...
            <tr>
                <td width="600">
                    <div style="padding-left: 30px; padding-right: 30px;">
                        ...
                        <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~16402402689856441f-1dd5-422d-ad2d-a7b32a9bac8b.png"
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width: 15%">
                                                <p style="font-weight: bold;color: #FF5E5E">Rp
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50%;">
                                                ...
                                                <p style="color: #666;">{{ $order->delivery->address ?? '-' }},
