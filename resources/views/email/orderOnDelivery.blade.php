            ...
            <tr>
                <td width="600">
                    <div style="padding-left: 30px; padding-right: 30px;">
                        ...
                        <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~164023054640382afa-6f9f-4743-94d8-b7bb97c8a802.png" alt=""
                        style="max-width: 150px;display:block;margin-left: auto;margin-right: auto;">

                        <p style="color: #666;font-size: 15px;">Pesanan Anda saat ini sedang dalam proses pengiriman. Silakan cek nomor resi yang tercantum di bawah ini.</p>
                            ...
                            <div style="padding: 2px 5px;display: grid;grid-template-columns: 200px 230px;grid-gap: 10px;padding: 10px;">
                                <div style="padding:10px;">
                                    ...
                                    <div>
                                        ...
                                        <p style="color: #666;margin-top: 0;font-weight: bold;text-transform:uppercase;">
