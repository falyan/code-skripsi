                        ...
                        <tbody>
                            <tr>
                                <td align="left" style="padding-left:30px;">
                                    ...
                                    line-height: 1.6;">
                                        Pembayaran terverifikasi dan pesanan
            ...
            <tr>
                <td width="600">
                    <div style="padding-left: 30px; padding-right: 30px;">
                        <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~16401604747b282faf-4557-433d-a0b3-d30709ce7976.png" alt=""
                                ...
                                <tr>
                                    <td align="left">
                                        <a style="width: 50px;padding-right: 10px;">
                                            <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~16401618941a5f4665-7d67-47d2-97d9-e34b33b82fec.png" alt=""
                                            style="max-width: 30px;">
                                        </a>
                                    </td>
                                    <td align="left">
                                        <p style="font-size: small;color: #FF5E5E;padding: 0;">Jangan memberitahukan bukti dan data pembayaran kepada
                                            pihak manapun kecuali <span style="font-weight: bold;">Marketplace</span>.</p>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div>
                            ...
                            <table style="width: 100%;">
                                <tbody>
                                    <tr>
                                        <td style="font-size: 14px;color:#666;width: 50%;">{{ $order->payment->payment_method ?? '-' }}</td>
                                        <td style="font-weight:bold;text-align:right;">Rp {{number_format($order->payment->payment_amount, 2, ',', '.')}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
