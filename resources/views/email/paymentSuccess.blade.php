            ...
            <tr>
                <td width="600">
                    <div style="padding-left: 30px; padding-right: 30px;">
                        <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~16401604747b282faf-4557-433d-a0b3-d30709ce7976.png"
                                ...
                                <table style="margin: 0px 10px 0px 10px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-weight: bold;">
                                            {{ \Carbon\Carbon::parse($order->payment->date_created)->isoFormat('dddd, D MMMM Y, H:m') }}
                                            WIB</td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <tr>
                                    <td align="left">
                                        <a style="width: 50px;padding-right: 10px;">
                                            <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~16401618941a5f4665-7d67-47d2-97d9-e34b33b82fec.png"
