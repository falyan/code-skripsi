...
<head>
    ...
    <title>Pengajuan Pesanan Ditolak</title>
</head>
                        ...
                        <tbody>
                            <tr>
                                <td align="left" style="padding-left:30px;">
                                    ...
                                    line-height: 1.6;">
                                        Persetujuan Bantuan Anda Ditolak
                                    </h2>
            ...
            <tr>
                <td width="600">
                    <div style="padding-left: 30px; padding-right: 30px;">
                        <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~1640143506d37b60b7-80b4-4a35-9e8e-e3491a335612.png"
                            alt="" style="max-width: 150px;display:block;margin-left: auto;margin-right: auto;">
                        <p style="color: #666;font-size: 15px;">Persetujuan Bantuan untuk pesanan Anda telah ditolak.
                            Anda tetap dapat melanjutkan transaksi harga normal dengan detail pesanan sebagai berikut:
                        </p>
                                ...
                                <table style="width: 100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <span
                                                    style="color: #666;margin-top: 0;font-weight: bold;vertical-align: middle;">{{ $order->trx_no }}</span>
                                            </td>
                                            <td>
                                                <div style="vertical-align: middle;">
                                                    <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~1640238761dde367ed-00b0-4dc4-ac0a-01167e12cb72.png"
                                                        alt=""
                                                        style="display: inline-block;max-width: 22px;vertical-align: middle;">
                                                    <span
                                                        style="color: #00A92F;margin-top: 0;font-weight: bold;display:inline-block; vertical-align: middle;">{{ $order->progress_active->status_name }}</span>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <table style="width: 100%;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-weight:bold;text-align:right;">
                                            {{ $order->detail->sum('total_insurance_cost')
                                                ? 'Rp ' . number_format($order->detail->sum('total_insurance_cost'), 2, ',', '.')
                                                : 'Rp 0' }}
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr>
                                        <td
                                            ...
                                            Subtotal Tagihan</td>
                                        <td style="padding:0px 0px 30px 0px;font-weight:bold;text-align:right;">Rp.
                                            {{ number_format(
                                                $order->detail->sum('total_price') + $order->delivery->delivery_fee + $order->detail->sum('total_insurance_cost'),
                                            ) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 14px;color:#666;width: 50%;">Potongan Bantuan</td>
                                        <td style="font-weight:bold;text-align:right;">Rp
                                            {{ number_format($order->detail->sum('total_insentif')) }}</td>
                                    </tr>
                                    <tr>
                ...
                <td>
                    ...
                    <p style="text-align: center;opacity: 80%;color:#fff">
                        <a style="width: 15px;display: inline-block;padding-top: 8px;margin-right: 10px;">
                            <img src="https://dev-stroom.air.id/plnmp/sauron-staging/api/firebase/file/load/Marketplace~merchants~1640230158dc832050-d7a1-49a6-b873-54c917bc787f.png"
